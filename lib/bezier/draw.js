...
function bindDrawFunctions(idx,options) {

    if( _.isUndefined(options) )
	options = {};

    var figure = find("figure")[idx];
    var cvs = document.getElementById("bezier_canvas"); // document.createElement("canvas");
    cvs.width  = _.isUndefined(options.canvasWidth)  ? 480 : options.canvasWidth;
    cvs.height = _.isUndefined(options.canvasHeight) ? 640 : options.canvasHeight;
    //throw "err";
